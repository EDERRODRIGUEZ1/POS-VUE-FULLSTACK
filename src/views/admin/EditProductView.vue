<script setup>
    ...
    watch(product, (product)=> {
        //Evaluamos que haya un prodcuto si no, no se muetra el formulario de edicion
        // y ser redirecciona el usuario
        if(!product) {
            router.push({name: 'products'})
        }
        //Llenando el formulario de edicion con este truco
